...
import br.com.academiadoflutter.pizzaDeliveryApi.exception.UserNotFoundException;
...
public class UserService {
    ...
    public void register(UserRegisterInputModel model){
        ...
        final var cryptPassword = new BCryptPasswordEncoder().encode(model.getPassword());
